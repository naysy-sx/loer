...
<div id="editor">
	...
	<div class="buttons-wrapper">
		<button class="btn btn-success" id="save-doc" style="display: block; max-width: 120px;">Сохранить</button>
...
<div class="container -relative">
	...
	<div class="doc document <?= Html::encode($current_doc['translit_type']) ?>-wrapper" id="content" contenteditable>
		...
		<div class="document-header">
			...
			<div class="document-header-list">
				...
				<div class="document-header-block">
					<div class="document-header-line"><span>________________________</span></div>
					<div class="document-header-line"><span>___________ШАПКА________</span></div>
					<div class="document-header-line"><span>________________________</span></div>
				</div>
		...
		<div class="document-subtitle">
			<h2>Дело № <span>_____________</span></h2>
...
<script>
	...
	*/
	...
	$(document).on('click', '#save-doc', function() {
		...
		/*  id	creator_id	folder_id	title	type	pravo	create_date	publish_status	content	last_modified_date	last_modified_by	tags	
		 */
		...
		$.ajax({
			url: '<?= \yii\helpers\Url::to(['documents/create', 'id' => $id]) ?>/',
			type: 'POST',
			data: {
