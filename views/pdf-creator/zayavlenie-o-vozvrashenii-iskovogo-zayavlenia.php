...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>о возвращении искового заявления</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>&#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года Истец направил исковое заявление в <?=$data['delo_sud']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
    <p><div class="redline"></div>В соответствии  со статьей 135 Гражданского   процессуального кодекса  РФ считаю необходимым вернуть указанное исковое заявление без рассмотрения, поскольку <?=$data['delo_pricina']?>.</p>
...
<p><div class="redline"></div>1. Возвратить исковое заявление <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
