...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>об отмене заочного решения</p>
    <br>
</div>
<div class="main">
    <p><div class="redline"></div>&#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года <?=$data['delo_sud']?> вынесено заочное решение по делу № <?=$data['delo_number2']?> согласно которому <?=$data['delo_soglasnokotoromy']?>.</p>
    <p><div class="redline"></div></p>
    <p><div class="redline"></div>Копию заочного решения я получил &#171;<?=$data['polychenie_day']?>&#187; <?=$data['polychenie_month']?> <?=$data['polychenie_year']?> года.</p>
    <p><div class="redline"></div>В судебное заседание не явился в связи с <?=$data['delo_pricina']?>.</p>
    <p><div class="redline"></div>У меня отсутствовала возможность сообщить суду о причинах своей неявки, поскольку <?=$data['delo_pricina2']?>.</p>
    <p><div class="redline"></div>В целях всестороннего, полного и объективного рассмотрения дела и вынесения законного решения суду будут предоставлены дополнительные доказательства в опровержение заявленных требований, в частности <?=$data['delo_dokazatelstva']?>.</p>
    <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Отменить заочное решение по делу № <?=$data['delo_number2']?> по иску <?=$data['delo_isk']?> к <?=$data['istec_fio']?> о <?=$data['delo_o']?>, и возобновить рассмотрение дела по существу.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
