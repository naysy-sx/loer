...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о возвращении апелляционной жалобы</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>&#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года <?=$data['delo_sud']?> вынесено <?=$data['delo_vynesenno']?> по делу № <?=$data['delo_number2']?> согласно которому <?=$data['delo_soglasnokotoromy']?>.</p>
    <p><div class="redline"></div>&#171;<?=$data['appelatsya_day']?>&#187; <?=$data['appelatsya_month']?> <?=$data['appelatsya_year']?> года <?=$data['appelatsya_kem']?> была направлена апелляционная жалоба на вышеуказанное решение суда.</p>
    <p><div class="redline"></div></p>
    <p><div class="redline"></div><?=$data['appelatsya_kto']?> считает необходимым возвратить апелляционную жалобу в связи с <?=$data['appelatsya_pricina']?>.</p>
    <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Возвратить апелляционную жалобу от <?=$data['zhaloba_ot']?> на <?=$data['zhaloba_na']?> по делу № <?=$data['delo_number2']?> по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.
</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
