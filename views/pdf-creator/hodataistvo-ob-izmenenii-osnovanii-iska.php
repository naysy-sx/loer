...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>об изменении оснований иска</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В ходе рассмотрения дела было установлено, что <?=$data['delo_ustanovleno']?>. В связи с этим Истец считает необходимым изменить предмет иска, изложив его в новой редакции <?=$data['delo_new']?>.</p>
...
<p><div class="redline"></div>1. Принять изложенные обстоятельства в качестве обоснования исковых требований по делу &#8470; <?=$data['delo_number2']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
