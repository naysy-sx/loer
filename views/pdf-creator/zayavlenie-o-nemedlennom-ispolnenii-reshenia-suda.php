...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>о немедленном исполнении решения суда</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>&#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года <?=$data['delo_sud']?> было вынесено решение по делу <?=$data['delo_delo']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
    <p><div class="redline"></div></p>
    <p><div class="redline"></div>В соответствии с общими правилами гражданского судопроизводства решение вступает в силу после истечения срока апелляционного обжалования. В то же время ст. 212 ГПК РФ суду предоставлено право обратить решение суда к немедленному исполнению, когда исходя из особых обстоятельств замедление исполнения такого решения может привести к значительному ущербу или исполнение может оказаться невозможным.</p>
    <p><div class="redline"></div><?=$data['appelatsya_kto']?> считает, что замедление исполнения вынесенного судебного решения может привести к <?=$data['appelatsya_kchemy']?>.</p>
    <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Обратить решение <?=$data['delo_sud2']?> от <?=$data['delo_date']?> года к немедленному исполнению.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
