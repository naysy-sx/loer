...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>о привлечении третьего лица</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>Решение суда по данному делу может повлиять на права и обязанности <?=$data['delo_prava']?> в части <?=$data['delo_chast']?>.</p>
...
<p><div class="redline"></div>1. Привлечь <?=$data['delo_kto']?> к участию в деле в качестве третьего лица, не заявляющего самостоятельных требований на предмет спора.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
