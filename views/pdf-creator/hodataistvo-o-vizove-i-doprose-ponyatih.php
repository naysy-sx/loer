...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о вызове и допросе понятых</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>Заявитель считает необходимым вызвать и допросить в судебное заседание понятых <?=$data['delo_ponyatoi']?>, поскольку <?=$data['delo_pricina']?>.</p>
...
<p><div class="redline"></div>1. Вызвать в судебное заседание и допросить: <?=$data['delo_ponyatoi']?>.</p>
<p><div class="redline"></div></p>
