...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>об отложении судебного заседания</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>На судебное заседание <?=$data['delo_kto']?> явиться не сможет по причине <?=$data['delo_pricina']?>.</p>
...
<p><div class="redline"></div>1. Отложить рассмотрение дела об административном правонарушении на более позднюю дату;</p>
<p><div class="redline"></div>2.  Не рассматривать указанное дело в мое отсутствие, поскольку это может серьезно нарушить мои интересы, как лица, привлекаемого к административной ответственности по данному делу.</p>
<p><div class="redline"></div></p>
