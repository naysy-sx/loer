...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>о взыскании судебных расходов</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В ходе рассмотрения дела <?=$data['delo_ponesizderzhki']?> понес следующие издержки: <?=$data['delo_izderzhki']?>.</p>
  <p><div class="redline"></div></p>
    <p><div class="redline"></div>Общая сумма судебных расходов составляет <?=$data['delo_rashody']?> рублей.</p>
    <p><div class="redline"></div></p>
    <p><div class="redline"></div>В соответствии со статьей 98 ГПК РФ, стороне, в пользу которой состоялось решение суда, суд присуждает возместить с другой стороны все понесенные по делу судебные расходы. В случае, если иск удовлетворен частично, указанные в настоящей статье судебные расходы присуждаются истцу пропорционально размеру удовлетворенных судом исковых требований, а ответчику пропорционально той части исковых требований, в которой истцу отказано.</p>
    <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Взыскать с <?=$data['delo_vziskats']?> в пользу <?=$data['delo_vziskatk']?> судебные расходы в связи с рассмотрением дела <?=$data['delo_number2']?> в размере <?=$data['delo_rashody']?> рублей.
</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
