...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>о восстановлении срока исковой давности</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>Истец обратился в <?=$data['delo_sud']?> с исковым заявлением к Ответчику о <?=$data['delo_o']?>.</p>
    <p><div class="redline"></div>В соответствии со статьей 196 ГК РФ, общий срок исковой давности устанавливается в три года.</p>
    <p><div class="redline"></div>В соответствии со статьей 205 ГК РФ, в исключительных случаях, когда суд признает уважительной причину пропуска срока исковой давности по обстоятельствам, связанным с личностью истца (тяжелая болезнь, беспомощное состояние, неграмотность и т.п.), нарушенное право гражданина подлежит защите.</p>
    <p><div class="redline"></div>О нарушении своего права мне стало известно <?=$data['delo_izvestno']?>. Считаю, что пропустил срок исковой давности по уважительной причине <?=$data['delo_pricina']?>.</p>
...
<p><div class="redline"></div>1. Восстановить срок исковой давности по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
