...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>об уменьшении размера госпошлины</p>
    <br>
...
<p><div class="redline"></div>1. Уменьшить размер государственной пошлины при рассмотрении искового заявления <?=$data['delo_zayavlenie']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
