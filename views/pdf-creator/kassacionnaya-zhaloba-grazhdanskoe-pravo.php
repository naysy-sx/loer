...
<div class="main">
    ...
    <p><div class="redline"></div>&#171;<?=$data['delo_day2']?>&#187; <?=$data['delo_month2']?> <?=$data['delo_year2']?> года дело рассмотрено в апелляционной инстанции, при рассмотрении которого было вынесено апелляционное определение, которым <?=$data['delo_opredeleniye']?>.</p>
    <p><div class="redline"></div></p>
   <p><div class="redline"></div>С <?=$data['delo_schem']?> Заявитель не согласен, считает его/их не законным и не обоснованным по следующим основаниям:</p>
...
<p><div class="redline"></div>1. Отменить решение <?=$data['delo_sud']?> (<?=$data['sud_instancia1']?>) от  &#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div>Отменить апелляционное определение <?=$data['delo_appelatsiya']?> от &#171;<?=$data['delo_day2']?>&#187; <?=$data['delo_month2']?> <?=$data['delo_year2']?> года.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div>2. Направить дело для нового рассмотрения в <?=$data['delo_sud2']?> (<?=$data['sud_instancia1']?>)</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
<p><div class="redline"></div>Изменить решение <?=$data['delo_sud']?> (<?=$data['sud_instancia1']?>) от  &#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div>Изменить апелляционное определение <?=$data['delo_appelatsiya']?> от &#171;<?=$data['delo_day2']?>&#187; <?=$data['delo_month2']?> <?=$data['delo_year2']?> года.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div>Оставить в силе <?=$data['delo_ostavit']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div>Приложения:</p>
<p> <div class="redline"></div>1. Квитанция об оплате госпошлины;</p>
<p> <div class="redline"></div>2. Уведомление о направлении копии настоящей жалобы сторонам;</p>
