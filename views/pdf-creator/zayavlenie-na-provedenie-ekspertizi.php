...
<div class="main">
    ...
    <p><div class="redline"></div>В рамках дела считаем необходимым установить <?=$data['delo_ustanovit']?>.</p>
    <p><div class="redline"></div>Указанный вопрос входит в круг обстоятельств, имеющих значение для объективного разрешения дела и требует специальных познаний, в соответствии со ст. 79 ГПК РФ по делу может быть назначена <?=$data['delo_ekspertiza']?> экспертиза.</p>
    <p><div class="redline"></div>На разрешение экспертов прошу поставить следующие вопросы:</p>
    <p><div class="redline"></div>1. <?=$data['delo_voprosy']?></p>
    <p><div class="redline"></div></p>
    <p><div class="redline"></div>Поручить <?=$data['delo_ekspertiza']?> экспертизу прошу <?=$data['delo_komy']?>, оплату судебных расходов на ее проведение возложить на заявителя.</p>
    <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Назначить в рамках дела № <?=$data['delo_number2']?> <?=$data['delo_ekspertiza']?> экспертизу, на разрешение которой поставить вышеперечисленные вопросы.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
