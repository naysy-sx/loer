...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>об отсрочке/рассрочке уплаты штрафа</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div><?=$data['delo_sud']?> было вынесено постановление по делу &#8470; <?=$data['delo_number2']?> о привлечении Заявителя к административной ответственности по <?=$data['delo_privlechenpo']?> КоАП РФ в виде административного штрафа в размере <?=$data['delo_shtraf']?> рублей.</p>
    <p><div class="redline"></div>В связи с невозможностью оплатить штраф в виду тяжелого материального положения, а именно: <?=$data['delo_pricina']?>, Заявитель считает необходимым предоставить отсрочку/рассрочку по оплате административного штрафа на срок <?=$data['delo_srok']?>.</p>
...
<p><div class="redline"></div>1. Предоставить отсрочку/рассрочку по оплате административного штрафа на срок до <?=$data['delo_do']?>.</p>
<p><div class="redline"></div></p>
