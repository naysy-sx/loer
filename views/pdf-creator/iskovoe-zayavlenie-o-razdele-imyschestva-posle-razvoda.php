...
<div class="title">
    ...
    <p>о разделе имущества после развода</p>
    <br>
</div>
<div class="main">
    <p><div class="redline"></div>Истец и Ответчик состояли в зарегистрированном браке с <?=$data['brak_start']?> года по <?=$data['brak_end']?> года. Фактически, семейные отношение и совместная жизнь закончились с <?=$data['brak_factend']?> года. С этого же времени не ведем общее хозяйство. Раздел имущества во время расторжения брака не производился т.к. <?=$data['brak_prichina']?>.</p>
...
<br>
    ...
    <p><div class="redline"></div>1. Произвести раздел общего имущества между <?=$data['istec_fio']?> и <?=$data['otvetchick_fio']?> следующим образом: <?=$data['brak_razdelit']?></p>
<p><div class="redline"></div></p>
