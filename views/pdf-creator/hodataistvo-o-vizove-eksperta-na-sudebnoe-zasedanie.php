...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о вызове эксперта на судебное заседание</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>С предоставленным по результатам проведения экспертизы заключением ознакомлен, однако, возникают следующие вопросы к эксперту: <?=$data['delo_voprosy']?>.</p>
    <p><div class="redline"></div>Указанные основания имеют существенное значение для рассмотрения дела. Без их разрешения и уточнения, экспертное заключение не может быть принято в качестве допустимого доказательства по делу. Разрешить возникшие противоречия возможно путем вызова эксперта в суд и опроса его в судебном заседании.</p>
...
<p><div class="redline"></div>1. Вызвать на судебное заседание эксперта <?=$data['delo_ekspert']?> для дачи пояснений по проведенной по делу экспертизе.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
