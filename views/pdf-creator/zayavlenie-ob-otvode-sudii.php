...
<div class="main">
    <p><div class="redline"></div>В производстве <?=$data['delo_sud']?> рассматривается дело по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>. Дело рассматривает федеральный судья <?=$data['delo_sudia']?>.</p>
    <p><div class="redline"></div>Полагаю, что указанный судья не вправе рассматривать данное дело в связи с тем, что <?=$data['delo_pricina']?>. Данное обстоятельство вызывает сомнение в беспристрастности судьи.</p>
...
<p><div class="redline"></div>1. Удовлетворить отвод федеральному судье <?=$data['delo_sudia']?> по делу &#8470; <?=$data['delo_number2']?></p>
<p><div class="redline"></div>2. Передать дело &#8470; <?=$data['delo_number3']?> по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?> на рассмотрение другого судьи.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
