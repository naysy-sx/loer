...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>об исправлении недостатков иска</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>Определением <?=$data['delo_sud']?> от <?=$data['delo_date']?> года исковое заявление <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?> оставлено без движения сроком до <?=$data['delo_do']?> года в связи с <?=$data['delo_pricina']?>.</p>
    <p><div class="redline"></div>Во исполнение определения суда <?=$data['delo_kto']?> считает необходимым <?=$data['delo_neobhodimo']?>.</p>
...
<p><div class="redline"></div>1. Приобщить к ранее поданному исковому заявлению <?=$data['delo_kzayavleniu']?>.</p>
<p><div class="redline"></div>2. Принять к производству исковое заявление <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?> к рассмотрению</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
