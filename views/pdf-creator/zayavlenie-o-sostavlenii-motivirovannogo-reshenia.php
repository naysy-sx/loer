...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>о составлении мотивированного решения суда</p>
    <br>
</div>
<div class="main">
    <p><div class="redline"></div>&#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года <?=$data['delo_sud']?> вынесено решение по делу № <?=$data['delo_number2']?> согласно которому <?=$data['delo_soglasnokotoromy']?>.</p>
    <p><div class="redline"></div>В целях ознакомления с позицией суда относительно установленных им обстоятельств по делу, принятых доказательств, а также применимых норм и законов, необходимо ознакомиться с мотивированным решением.</p>
...
<p><div class="redline"></div>1. Составить мотивированное решение по делу № <?=$data['delo_number2']?> по иску <?=$data['delo_isk']?> к <?=$data['istec_fio']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
