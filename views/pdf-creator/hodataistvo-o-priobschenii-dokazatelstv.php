...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о приобщении доказательств к материалам дела</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В целях полного, всестороннего и объективного рассмотрения дела Заявитель считает необходимым сообщить следующие сведения: <?=$data['delo_svedenia']?> и в связи с этим приобщить к материалам дела следующие документы <?=$data['delo_documents']?>.</p>
    <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Приобщить к материалам дела &#8470; <?=$data['delo_number2']?> настоящее объяснение;</p>
<p><div class="redline"></div>2. Приобщить к материалам дела &#8470; <?=$data['delo_number2']?> следующие документы: <?=$data['delo_documents']?>.</p>
<p><div class="redline"></div></p>
