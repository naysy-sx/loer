...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о переносе судебного заседания</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>На судебное заседание <?=$data['delo_yavitsa']?> явиться не сможет по причине <?=$data['delo_pricina']?>.</p>
...
<p><div class="redline"></div>1. Перенести судебное заседание по рассмотрению дела № <?=$data['delo_number2']?> по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?> на срок не ранее <?=$data['delo_srok']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
