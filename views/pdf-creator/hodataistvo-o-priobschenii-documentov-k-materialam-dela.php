...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о приобщении документов к материалам дела</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>Истец считает необходимым приобщить к материалам дела следующие документы, имеющие значение для рассмотрения дела <?=$data['delo_documents']?>.</p>
...
<p><div class="redline"></div>1. Приобщить к материалам дела &#8470; <?=$data['delo_number2']?> дополнительные документы: <?=$data['delo_documents']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
