...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>об обеспечении иска</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>Истец обратился в <?=$data['delo_sud']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
    <p><div class="redline"></div></p>
    <p><div class="redline"></div>Истец полагает, что Ответчик предпримет ряд мер по сокрытию своего имущества в целях невозможности обращения на него взыскания в рамках исполнительного производства. О недобросовестном поведении ответчика свидетельствует тот факт, что <?=$data['delo_fact']?>.</p>
     <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Принять меры по обеспечению иска <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?> в виде наложения ареста на следующее имущество <?=$data['delo_imuschestvo']?> и установить запрет на совершение сделок, направленных на отчуждение этого имущества.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
