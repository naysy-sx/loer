...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>об увеличении размера исковых требований</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>В производстве <?=$data['delo_sud']?> рассматривается дело по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>. Цена иска составила <?=$data['delo_cena']?>.</p>
    <p><div class="redline"></div>Истец считает необходимым увеличить исковые требования, поскольку <?=$data['delo_pricina']?>.</p>
...
<p><div class="redline"></div>1. Принять настоящее ходатайство к материалам дела &#8470; <?=$data['date_number2']?></p>
<p><div class="redline"></div>2. Взыскать с <?=$data['vziskat_s']?> в пользу <?=$data['vziskat_komy']?> денежные средства в размере <?=$data['vziskat_razmer']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
