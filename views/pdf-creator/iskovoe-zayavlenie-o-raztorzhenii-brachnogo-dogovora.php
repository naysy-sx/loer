...
<div class="title">
    ...
    <p>о расторжении брачного договора</p>
    <br>
</div>
<div class="main">
    ...
    <p><div class="redline"></div>В соответствии со статьями 40-41 СК РФ мы заключили брачный договор, удостоверенный нотариусом <?=$data['dogovor_date']?> года, регистрационный номер № <?=$data['dogovor_number']?>.</p>
    <p> <div class="redline"></div>Согласно условиям брачного договора <?=$data['dogovor_uslovia']?>. </p>
    <p><div class="redline"></div>Однако, с момента заключения договора существенно изменились обстоятельства, при которых он был заключен, а именно <?=$data['dogovor_izmenenie']?>.</p>
...
<br>
    ...
    <p><div class="redline"></div>1. Расторгнуть брачный договор, заключенный между <?=$data['istec_fio']?> и <?=$data['otvetchick_fio']?>, от <?=$data['dogovor_date']?> года, нотариально удостоверенным под номером № <?=$data['dogovor_number']?>.</p>
<p><div class="redline"></div></p>
...
<p> <div class="redline"></div> 3. Оригинал брачного договора; </p>
