...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>об исправлении описки в решении суда</p>
    <br>

</div>
<div class="main">
    <p><div class="redline"></div>&#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года <?=$data['delo_sud']?> вынесено решение по делу № <?=$data['delo_number2']?> согласно которому <?=$data['delo_opicanie']?>. При написании судебного акта допущены следующие ошибки <?=$data['delo_oshibki']?>. В то время как правильным является <?=$data['delo_pravilno']?>, что подтверждается <?=$data['delo_podtverzhdenie']?>.</p>
    <p><div class="redline"></div>Допущенные описки являются явными, не влекут изменение или отмену решения суда и подлежат исправлению.</p>
...
<p><div class="redline"></div>1. Исправить допущенные в решении от <?=$data['delo_date']?> года описки, вместо <?=$data['delo_vmesto']?> указав <?=$data['delo_ukazat']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
