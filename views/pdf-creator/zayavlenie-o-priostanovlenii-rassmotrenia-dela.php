...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>о приостановлении рассмотрения дела</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div><?=$data['appelatsya_kto']?> считает необходимым приостановить производство по делу в связи с <?=$data['appelatsya_pricina']?>.</p>
...
<p><div class="redline"></div>1. Приостановить производство по делу № <?=$data['delo_number2']?> по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<br>
<br>
