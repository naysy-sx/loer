...
<div class="title">
    ...
    <p>об определении места жительства ребенка</p>
    <br>
</div>
<div class="main">
    <p><div class="redline"></div>Истец и Ответчик состояли в зарегистрированном браке с <?=$data['brak_start']?> года по <?=$data['brak_end']?> года. По решению суда брак между нами был расторгнут.</p>
    <p><div class="redline"></div>От брака имеется несовершеннолетний ребенок <?=$data['child_fio']?>. Ребенок в настоящее время проживает с <?=$data['child_prozhivaets']?>. Я считаю, что ребенок должен проживать со мной по следующим причинам: <?=$data['delo_prichina']?>.</p>
...
<br>
    ...
    <p><div class="redline"></div>1. Определить место жительства <?=$data['child_fio']?>, <?=$data['child_birth']?> года рождения с <?=$data['istec_fio']?>.</p>
<p><div class="redline"></div></p>
