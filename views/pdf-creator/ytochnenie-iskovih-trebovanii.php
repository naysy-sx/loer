...
<div class="title">
    <br>
    <p>Уточнение исковых требований</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В связи с допущенными ошибками при составлении искового заявления, считаю необходимым уточнить заявленные требования, а именно: <?=$data['delo_trebovania']?>.</p>
...
<p><div class="redline"></div>1. Принять настоящее уточнение исковых требований;</p>
