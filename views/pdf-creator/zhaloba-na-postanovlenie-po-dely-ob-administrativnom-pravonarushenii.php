...
<body>
<div class="column">
<p>В <?=$data['sud_name']?> (<?=$data['sud_instancia1']?>)</p>
...
<div class="title">
    <br>
    <p>Жалоба</p>
    <p>на постановление по делу об административном правонарушении</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>Заявитель считает вышеуказанное постановление незаконным и не обоснованным по следующим основаниям:</p>
