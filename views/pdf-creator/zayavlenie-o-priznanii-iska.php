...
<div class="main">
    ...
    <p><div class="redline"></div>Ответчик считает, что требования Истца обоснованы и соответствуют закону, в связи с чем признает их в полном объеме. Ответчику известны и понятны требования статей 35, 39, 173 Гражданского процессуального кодекса РФ. Признание иска не противоречит закону и не нарушает права и законные интересы других лиц. Ответчик уведомлен, что, принимая признание иска, суд вынесет решение об удовлетворении исковых требования истца.</p>
   <p><div class="redline"></div></p>
...
<p><div class="redline"></div>1. Принять признание иска в полном объеме по делу по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
