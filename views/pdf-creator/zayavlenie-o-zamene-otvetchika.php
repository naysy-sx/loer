...
<div class="main">
    ...
    <p><div class="redline"></div>В ходе рассмотрения дела было установлено, что Ответчик не является надлежащим, поскольку <?=$data['delo_pricina']?>, также было установлено, что надлежащим Ответчиком будет являться <?=$data['delo_kto']?>.</p>
...
<p><div class="redline"></div>1. Заменить ненадлежащего Ответчика <?=$data['delo_zamenit']?> на надлежащего <?=$data['delo_kto']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
