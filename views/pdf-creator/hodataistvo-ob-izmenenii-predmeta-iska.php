...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>об изменении предмета иска</p>
    <br>
...
<p><div class="redline"></div>1. Изменить предмет искового заявления <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>: <?=$data['delo_izmenenia']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
