...
<div class="main">
   ...
   <p><div class="redline"></div>С кассационной жалобой не согласен по следующим основаниям:</p>
...
<p><div class="redline"></div>1. Оставить решение <?=$data['delo_sud']?> (<?=$data['sud_instancia1']?>) от  &#171;<?=$data['delo_day']?>&#187; <?=$data['delo_month']?> <?=$data['delo_year']?> года по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?>.</p>
<p><div class="redline"></div>и/или апелляционное определение <?=$data['delo_appelatsiya']?> от &#171;<?=$data['delo_day2']?>&#187; <?=$data['delo_month2']?> <?=$data['delo_year2']?>  года без изменения, кассационную жалобу без удовлетворения.</p>
<p><div class="redline"></div></p>
