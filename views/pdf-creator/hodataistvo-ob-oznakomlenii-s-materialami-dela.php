...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>об ознакомлении с материалами дела</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В соответствии со статьей 35 Гражданского процессуального кодекса РФ, лица, участвующие в деле, имеют право знакомиться с материалами дела, делать выписки из них, снимать копии.</p>
    <p><div class="redline"></div><?=$data['delo_kto']?> необходимо ознакомиться с материалами дела.</p>
...
<p><div class="redline"></div>1. Предоставить возможность ознакомиться с материалами дела № <?=$data['delo_number2']?> с использованием фотосъемки.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
