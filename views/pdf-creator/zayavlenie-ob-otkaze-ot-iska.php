...
<div class="title">
    <br>
    <p>Заявление</p>
    <p>об отказе от исковых требований</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В связи с <?=$data['delo_pricina']?>, Истец считает необходимым отказаться от исковых требований.</p>
    <p><div class="redline"></div>Отказ заявлен добровольно. Последствия отказа от иска, предусмотренные статьей 221 ГПК РФ Истцу известны. В случае принятия отказа от иска производство по делу прекращается определением суда, при этом повторное обращение в суд по спору между теми же сторонами, о том же предмете и по тем же основаниям не допускается, мне известны.</p>
...
<p><div class="redline"></div>1. Принять отказ от исковых требований <?=$data['delo_trebovaniya']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?> .</p>
<p><div class="redline"></div>2. Прекратить производство по делу в связи с отказом Истца от исковых требований.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
