...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>в рассмотрении дела в отсутствие стороны</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>Явиться на судебное заседание не могу в связи с: <?=$data['delo_pricina']?>.</p>
...
<p><div class="redline"></div>1. Рассмотреть дело № <?=$data['delo_number2']?> по иску <?=$data['delo_isk']?> к <?=$data['delo_k']?> о <?=$data['delo_o']?> в мое отсутствие.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
