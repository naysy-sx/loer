...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о вызове свидетелей на судебное заседание</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В целях подтверждения юридически значимых обстоятельств, имеющих значение для правильного рассмотрения и разрешения дела, таких как <?=$data['delo_obstoyatelstva']?>, <?=$data['delo_schitaet']?> считает необходимым пригласить в суд и допросить в судебном заседании свидетелей: <?=$data['delo_svideteli']?>.</p>
...
<p><div class="redline"></div>1. Вызвать на судебное заседание свидетелей: <?=$data['delo_svideteli']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
