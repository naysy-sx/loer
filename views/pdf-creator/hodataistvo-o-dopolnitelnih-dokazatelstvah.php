...
<div class="title">
    <br>
    <p>Ходатайство</p>
    <p>о дополнительных доказательствах</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>В круг доказательств по гражданскому делу входит установление вины Ответчика. Юридически значимыми обстоятельствами являются <?=$data['delo_obstoyatelstva']?>.</p>
    <p><div class="redline"></div>В дополнение к заявлению Истец считает необходимым приобщить к материалам дела следующие документы <?=$data['delo_documents']?>.</p>
...
<p><div class="redline"></div>1. Приобщить к материалам дела № <?=$data['delo_number2']?> настоящее ходатайство, содержащее дополнительные доказательства.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
