...
<body>
<div class="column">
<p>В <?=$data['sud_name']?> (<?=$data['sud_instancia2']?>)</p>
<p><?=$data['sud_address']?></p>
    <br>
    <p>Через:</p>
    <p><?=$data['sud_name']?> (<?=$data['sud_instancia1']?>)</p>
    <br>
...
<div class="main">
    ...
    <p><div class="redline"></div>С решением суда <?=$data['delo_kto']?> не согласен, считает его не законным и не обоснованным по следующим основаниям:</p>
...
<p><div class="redline"></div>2. Принять новое решение по делу, которым <?=$data['delo_new']?>.</p>
<p><div class="redline"></div></p>
<p><div class="redline"></div></p>
