...
class Calendar
{
    ...
    public static function getMonth($month, $year, $events = [])
    {
        ...
        for ($day = 1; $day <= $days_month; $day++) {
            ...
            if ($event_show) {
                $out .= '<td class="calendar-day ' . $class . ' event" data-day="' . $day . '" data-month="'.$month.'">' . $day;
                if (!empty($event_text)) {
                    $out .= '<div class="calendar-popup">' . implode('<br>', $event_text) . '</div>';
                }
                $out .= '</td>';
            } else {
                $out .= '<td class="calendar-day ' . $class . '" data-day="' . $day . '" data-month="'.$month.'">' . $day . '</td>';
            }
     ...
     * @return array
     */
    public static function getTaskArr($year, $month, $day, $type, $request = '')
    {
